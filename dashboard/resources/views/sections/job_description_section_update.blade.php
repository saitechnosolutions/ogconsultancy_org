            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Job Descripion</h4>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="custom-validation job_description_form"
                                                    action="/job_description/{{ $user_datas->id }}/update"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="user_id"
                                                            ...
                                                            value="{{ $user_datas->user_id }}" required />
                                                    </div>
                                                    <div class="mb-3 col-md-12 row">
                                                        <div
                                                            class="mb-3 col-md-12 row d-flex align-items-center description_sticky_form">
                                                            <div class="col-md-5">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="col-md-5" id="form-title-container">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $user_data->attribute }}" />
                                                                </div>
                                                                <div class="col-md-5" id="form-title-container">
                                                                    <textarea type="text" class="form-control" name="value[]" placeholder="value" id="banner-title" required>{{ $user_data->value }}</textarea>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <button
                ...
                @if (isset($job_descriptions) && $job_descriptions->count())
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Job Descripion</h4>
