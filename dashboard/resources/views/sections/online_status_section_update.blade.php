                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="custom-validation"
                                                    action="/online_status/{{ $user_datas->id }}/update" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                            placeholder="Add User Nam..." required=""
                                                            value="{{ $user_datas->name }}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Description</label>
                                                        <textarea type="text" id="editor" class="form-control" name="description" placeholder="Add description..."
                                                            style="height: 150px;">
